...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="LocIssue",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8LocIssue11AppDelegate")
...
SWIFT_CLASS("_TtC8LocIssue13SceneDelegate")
...
SWIFT_CLASS("_TtC8LocIssue14ViewController")
